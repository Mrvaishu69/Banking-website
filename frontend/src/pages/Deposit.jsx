...
import { getAccounts, depositMoney } from '../services/api';
...
const Deposit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const { data } = await depositMoney(formData);
  ...
  return (
    <div>
      <div className="page-header">
        <h1>💵 Deposit Money</h1>
        <p>Add funds to your Great Vaishu Bank account</p>
      </div>
      ...
      <div className="card" style={{ maxWidth: '500px' }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="text" placeholder="e.g., Salary, Gift" value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} />
          </div>
